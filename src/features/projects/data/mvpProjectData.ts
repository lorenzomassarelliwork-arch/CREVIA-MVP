...
export const MVP_PROJECTS: Project[] = [
  {
    ...
    locationMode: 'hybrid',
    city: 'Milano',
    expectedDuration: '3 mesi',
    weeklyCommitmentHours: 5,
    compensationType: 'unpaid',
    compensationNotes: 'Collaborazione non retribuita nella fase MVP del progetto.',
    status: 'recruiting',
  ...
  },
  {
    ...
    locationMode: 'onsite',
    city: 'Milano',
    expectedDuration: '2 mesi',
    weeklyCommitmentHours: 4,
    compensationType: 'unpaid',
    compensationNotes: 'Progetto collaborativo universitario non retribuito.',
    status: 'recruiting',
  ...
  },
  {
    ...
    locationMode: 'hybrid',
    city: 'Milano',
    expectedDuration: '10 settimane',
    weeklyCommitmentHours: 6,
    compensationType: 'paid_to_agree',
    compensationNotes: 'Eventuale compenso da concordare direttamente tra le parti. Crevia non gestisce pagamenti.',
    status: 'recruiting',
