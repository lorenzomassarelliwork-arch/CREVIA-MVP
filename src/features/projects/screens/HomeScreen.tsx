...
type HomeScreenProps = MaterialTopTabScreenProps<MainTabParamList, 'Home'>;
...
export default function HomeScreen({ navigation }: HomeScreenProps) {
  ...
  const renderProjectCard = (
    ...
    <TouchableOpacity
      key={project.id}
      activeOpacity={0.76}
      style={[styles.projectCard, variant === 'large' && styles.projectCardLarge]}
    >
...
const createStyles = (
  ...
  StyleSheet.create({
    ...
    projectCardLarge: { width: 280, minHeight: 212 },
