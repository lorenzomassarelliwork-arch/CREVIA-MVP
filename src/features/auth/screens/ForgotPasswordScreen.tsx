...
export default function ForgotPasswordScreen({ navigation }: Props) {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Il recupero password reale verrà collegato a Supabase nella fase backend.</Text>
      <TouchableOpacity style={styles.button} onPress={() => navigation.goBack()}><Text style={styles.buttonText}>Indietro</Text></TouchableOpacity>
    </View>
  );
}
